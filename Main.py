...
frame_corpo = Frame(janela, width = 235, height = 320)
...
b_19 = Button(frame_corpo, command=apaga_ultimo,  text = "X", width=23, height = 2, bg = cor4, font=('Ivy 13 bold'), relief = RAISED, overrelief=RIDGE)
b_19.place(x=0, y=262)
